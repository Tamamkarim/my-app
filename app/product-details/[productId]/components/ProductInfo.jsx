...
{product?.attributes?.description && // Check if description exists
product.attributes.description[0]?.children && // Check if children exists
 product.attributes.description[0].children[0]?.text // Check if text exists
 }
</h2>
